					...
					<div class="_box _b_radious3 _padd20">  
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-lg-12 _mar_b20">
                             ...
                             <div class="col-12 col-md-12 col-lg-12 _mar_b20">
                                 <br> <br> <br> <br>
                                 <Button type="primary" size="large" long :loading="loading" @click="updateCourse">
...
export default {
    ...
    addVideoToContent() {
        ...
        // console.log(this.videoContentItem, "this.videoContentItem")
        this.videoContentItem ={
            "source": "",
            "hours": "",
            "title": "",
    ...
    async updateCourse(){
        ...
        this.loading = true; 
        const res = await this.callApi("post", `course/updateCourse`, this.form);
        if (res.status == 200) {
    ...
    async getSingleCourse(){
        const res = await this.callApi("get", `course/getSingleCourse?id=${this.id}`);
        if (res.status == 200) {
            this.data = res.data
            ...
            this.cover.response.url = this.data.cover_pic;
            if(this.data.data){
                this.contentList = this.data.data
